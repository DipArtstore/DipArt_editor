...
import {
    DownloadPanelIcon,
    GraphicsPanelIcon,
    ImagePanelIcon, TextPanelIcon, UploadPanelIcon,
} from '../../../assets/icons';
    ...
    return (
        <div className="gnr-ed-toolbar-wrapper">
            <div className="toolbar_menu">
                <div onClick={() => toggleOpen('2')}
                     className={`tools_element d-flex flex-column align-items-center justify-content-center ${activeKey === '2' ? 'active-tab' : ''}`}>
                    <GraphicsPanelIcon fill={activeKey === '2' ? selectedIconColor : iconColor}/>
                    <span className="tools_title">Background</span>
                </div>
                <div onClick={() => toggleOpen('3')}
                     className={`tools_element d-flex flex-column align-items-center justify-content-center ${activeKey === '3' ? 'active-tab' : ''}`}>
                    <UploadPanelIcon fill={activeKey === '3' ? selectedIconColor : iconColor}/>
                    <span className="tools_title">Uploads</span>
                </div>
                <div onClick={() => toggleOpen('4')}
                     className={`tools_element d-flex flex-column align-items-center justify-content-center ${activeKey === '4' ? 'active-tab' : ''}`}>
